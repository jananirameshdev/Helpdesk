    ...
    return (
        <div className="dhbr">
            <div className="home">
                ...
                <div className="dashboard" style={{ background: "white", marginTop: "-934px", width: "100%", marginLeft: "250px", height: "600px", padding: "5%" }}>
                    <div className="boxs">
                        <div className="box1">
                            <div className="t1">Total Tickets</div>
                            <div className="n1">12</div>
                        </div>
                        <div className="box2">
                            <div className="t1">Total Solved</div>
                            <div className="n1">8</div>
                        </div>
                        <div className="box3">
                            <div className="t1">Total Awaiting Approval</div>
                            <div className="n1">2</div>
                        </div>
                        <div className="box4">
                            <div className="t1">Total in progress</div>
                            <div className="n1">2</div>
                        </div>
                    </div>
                </div>
